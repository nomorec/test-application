package co.test.co.repository;

import co.test.co.TestapplicationApp;
import co.test.co.config.Constants;
import co.test.co.config.audit.AuditEventConverter;
import co.test.co.domain.PersistentAuditEvent;
...
import static co.test.co.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
