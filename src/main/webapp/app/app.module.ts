...
@NgModule({
  imports: [
    ...
    TestapplicationSharedModule.forRoot(),
    TestapplicationCoreModule,
    TestapplicationHomeModule,
    TestapplicationAccountModule,
